...
alias galias='nano $OSH_CUSTOM/aliases/git.aliases.sh'
...
alias git.c='git commit -v'
alias git.c!='git commit -v --amend'
alias git.cn!='git commit -v --no-edit --amend'
alias git.ca='git commit -v -a'
alias git.ca!='git commit -v -a --amend'
alias git.can!='git commit -v -a --no-edit --amend'
alias git.cans!='git commit -v -a -s --no-edit --amend'
alias git.cam='git commit -a -m'
alias git.csm='git commit -s -m'
