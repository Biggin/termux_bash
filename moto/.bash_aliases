...
alias sub='scrub -SRfr -p gutmann'
alias bish='scrub -SRfr -p bsi ~/.bash_history'
...
alias fast.fp='fastboot flash partition'
alias fast.o='fastboot oem'
alias fast.fo='fastboot flash oem'
alias fast.ven='fastboot flash vendor'
...
alias git.hard='git reset --hard'
alias git.br='git branch'
alias git.bra='git branch -a --color=always'
