...
#alias reperr='repo sync --force-sync --prune --no-clone-bundle --no-tags --current-branch -j2'
alias repair='repo sync --detach --no-clone-bundle --force-remove-dirty --force-sync -j4'
>>>>>>> c5fe5703a7c7f73c105e3460c88f7f40f16f5eab
